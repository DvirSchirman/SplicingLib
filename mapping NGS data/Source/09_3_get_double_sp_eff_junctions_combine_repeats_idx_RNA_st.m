function get_double_sp_eff_junctions_combine_repeats_idx_RNA_st_log(idx)
...
files = dir([in_sample_folder '*_RNA_st_*']);
files={files.name};
...
save(sprintf('%sRNA_st_junctions_idx%d.mat',out_folder,idx),'double_sp_eff_tbl');
